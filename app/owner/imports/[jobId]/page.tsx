    ...
    <AppShell>
      ...
      <section className="mt-5 rounded-md border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {job.status === "NEEDS_MAPPING" ? <a href={`/owner/imports/${job.id}/mapping`} className="inline-flex min-h-11 items-center rounded-md bg-berry px-3 py-2 text-sm font-bold text-white">Map File Headers</a> : null}
