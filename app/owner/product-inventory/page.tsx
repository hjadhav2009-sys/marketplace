...
export default async function ProductInventoryPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return <AppShell>
    <div className="mx-auto w-full max-w-[1440px]">
      ...
      <form className="mb-4 grid min-w-0 gap-2 rounded-md border border-slate-200 bg-white p-3 shadow-sm xl:grid-cols-[minmax(18rem,1fr)_auto_auto_auto_auto_auto]">
