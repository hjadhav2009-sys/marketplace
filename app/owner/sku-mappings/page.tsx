          ...
          <div className="border-b border-slate-200 px-4 py-3">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              ...
              <form action={cacheVisibleSkuImagesAction}>
                ...
                <button
                  type="submit"
                  className="min-h-11 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm hover:border-berry hover:text-berry"
                >
                  Cache visible SKUs
                </button>
              </form>
            ...
            <form className="mt-3 grid gap-2 xl:grid-cols-[1fr_auto_auto_auto]">
              ...
              <button className="min-h-11 rounded-md border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50">
                Filter
              </button>
            </form>
          </div>
