...
2. Optionally choose Pick, Mark, Pack, or one authorized account.
...
This feature does not track inventory. Future Assembly, Product Design Identity, and Windows Worker Agent work remain separate roadmap items.
