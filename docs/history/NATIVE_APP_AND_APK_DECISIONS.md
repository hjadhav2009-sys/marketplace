...
Fully native React Native/Expo remains paused. No WebView, Expo run, Android build, APK or AAB work is authorized until backend review and manual warehouse gates pass.
