CREATE TYPE "Marketplace" AS ENUM ('FLIPKART', 'MEESHO', 'AMAZON', 'MYNTRA', 'SHOPIFY', 'WOOCOMMERCE', 'OTHER');

ALTER TABLE "Account" ADD COLUMN "companyName" TEXT NOT NULL DEFAULT 'Sullery';
ALTER TABLE "Account" ADD COLUMN "marketplace" "Marketplace" NOT NULL DEFAULT 'FLIPKART';
