export const AMAZON_HEADER_ALIASES = {
  ...
  sellerSku: ["seller sku", "seller-sku", "seller_sku", "merchant sku", "merchant-sku", "merchant_sku", "sku"],
  ...
  brand: ["brand", "brand name"], category: ["category", "product type", "product_type", "item type"], subCategory: ["sub category", "subcategory"],
  material: ["material", "material type"], color: ["colour", "color", "color name"], size: ["size", "size name"], modelNumber: ["model number", "model_number", "model"],
  description: ["description", "product description", "item description"],
  bullet1: ["bullet point 1", "bullet_point1", "bullet1", "key product features1"], bullet2: ["bullet point 2", "bullet_point2", "bullet2", "key product features2"], bullet3: ["bullet point 3", "bullet_point3", "bullet3"], bullet4: ["bullet point 4", "bullet_point4", "bullet4"], bullet5: ["bullet point 5", "bullet_point5", "bullet5"],
  ...
  listingStatus: ["listing status", "status", "item status"]
} as const;
