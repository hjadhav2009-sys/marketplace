...
const navigation = read("components/AppShell.tsx") + read("lib/app-navigation.ts");
...
assert.match(packScope, /resolveOrderShipmentWorkflowPrerequisites/);
assert.match(packScope, /scope\.workflow\.blocker/);
