...
const legacyWorkerSets: Array<[string, Partial<NavigationUser>, string[]]> = [
  ...
  ["packer", { role: "PACKER", canPack: true, canReportProblem: true }, ["/work", "/work/scan", "/work/pack", "/work/problems", "/change-password"]],
  ["pick-and-pack", { canPick: true, canPack: true, canReportProblem: true }, ["/work", "/work/scan", "/work/pick", "/work/pack", "/work/problems", "/change-password"]],
