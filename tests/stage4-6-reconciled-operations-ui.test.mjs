...
const groupedCard = read("app/work/GroupedWorkCard.tsx") + read("components/work-card/GroupedQuickActions.tsx") + read("components/work-card/WorkCard.tsx") + read("components/work-card/WorkCardQuantity.tsx");
const workDialog = read("components/work-card/WorkRouteDialogC1A.tsx") + read("components/worker-overlay/WorkerOverlay.tsx");
...
assert.doesNotMatch(groupedCard, /Identifiers and work context/);
assert.match(groupedCard, /Open full details/);
...
assert.match(workDialog, /event\.key !== "Tab"/);
assert.match(workDialog, /openerRef[\s\S]*\.focus/);
assert.match(scannerDialog, /event\.key !== "Tab"/);
assert.match(scannerDialog, /triggerRef\.current\?\.focus/);
